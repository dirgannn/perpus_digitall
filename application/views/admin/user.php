    ...
    <div class="columns" id="app-content">
        ...
        <div class="column is-10" id="page-content">
            ...
            <div class="content-body">
                <button><a href="<?= site_url('admin/user/tambah_user'); ?>">tambah user</a></button>
                <br>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($user as $pp) { ?>
                            <tr>
                                ...
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><?= $pp['username'] ?>
                                </td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><?= $pp['email'] ?>
                                </td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><?= $pp['alamat'] ?>
                                </td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;">
                                    <?= $pp['level'] ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;">
                                    <a href="<?= site_url('admin/user/delete_user/' . $pp['id_user']); ?>" class="btn btn-danger">Delete</a>
                                    <a href="<?= site_url('admin/user/edit_user/' . $pp['id_user']); ?>" class="btn btn-danger">Edit</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
