...
<head>
    ...
    <style>
        .content-body {
            display: flex;
            flex-wrap: nowrap;
            /* Menghindari baris baru */
            overflow-x: auto;
            /* Scroll horizontal jika kolom melebihi lebar container */
            gap: 20px;
            /* Ruang antara kolom */
            padding: 10px;
    ...
    <div class="columns" id="app-content">
        <div class="column is-2 is-fullheight is-hidden-touch" id="sidebar">
            <aside class="menu">
                ...
                <ul class="menu-list">
                    <li>
                        <a class="" href="<?= site_url('auth/login') ?>">
                            <span class="icon">
                                <i class="fa fa-lock"></i>
                            </span> Login
                        </a>
        ...
        <div class="column is-10" id="page-content">
            ...
            <div class="content-body">
                <div class="content-body">
                    <div class="column1">
                        <?php if (!empty('cover')) : ?>
                            <img src="<?= base_url('assets/uploads/covers/') . $buku['cover'] ?>" alt="Gambar 1">
                        <?php else : ?>
                            no image
                        <?php endif; ?>
                        <p>Penulis: <?= $buku['judul'] ?></p>
                        <p>Penulis: <?= $buku['penulis'] ?></p>
                        <p>Penerbit: <?= $buku['penerbit'] ?></p>
                        <p>Tahun Terbit: <?= $buku['tahun_terbit'] ?></p>
                        <p><?php if (!empty($buku['file'])) : ?>
                                <a href="<?= site_url('admin/buku/view_pdf/' . $buku['file']) ?>" target="_blank">View
                                    PDF</a>
                            <?php else : ?>
                                No file
                            <?php endif; ?>
