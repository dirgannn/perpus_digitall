            ...
            <div class="navbar-end">
                ...
                <div class="navbar-item has-dropdown is-hoverable">
                    <a class="navbar-link">
                        ...
                        &nbsp; Hi, <?= $this->session->userdata('level') ?>
                    </a>
    ...
    <div class="columns" id="app-content">
        ...
        <div class="column is-10" id="page-content">
            ...
            <div class="content-body">
                <!-- application/views/admin/list_izin.php -->

                <h1>Daftar Permintaan Akses</h1>
                    ...
                    <tbody>
                        <?php foreach ($izin as $i) : ?>
                            <tr>
                                ...
                                <td><?= $i['id_buku'] ?></td>
                                <td>
                                    <form method="post" action="<?= base_url('perizinan/update_izin') ?>">
                                        <input type="text" name="keterangan" placeholder="keterangan">
                                </td>
                                <td><?= $i['status'] ?></td>
                                <td>
                                    <input type="hidden" name="id_izin" value="<?= $i['id_izin'] ?>">
                                    <select name="status">
                                        <option value="approved" <?= $i['status'] == 'approved' ? 'selected' : '' ?>>
                                            Approve</option>
                                        <option value="rejected" <?= $i['status'] == 'rejected' ? 'selected' : '' ?>>
                                            Reject</option>
                                    </select>
