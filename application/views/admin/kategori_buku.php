...
<body>
    ...
    <div class="columns" id="app-content">
        ...
        <div class="column is-10" id="page-content">
            ...
            <div class="content-body">
                <button><a href="<?= site_url('admin/buku/tambah_kategori'); ?>">tambah kategori</a></button>
    ...
    text-align: left;">#</th>
                            <th style="  border: 1px solid #ddd;
    padding: 8px;
    text-align: left;">KATEGORI BUKU</th>
                            <th style="  border: 1px solid #ddd;
    padding: 8px;
    text-align: left;">AKSI</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $no = 1; ?>
    ...
    padding: 8px;
    text-align: left;"><?= $no++ ?></td>
                                <td style="  border: 1px solid #ddd;
    padding: 8px;
    text-align: left;"><?= $pp['nama_kategori'] ?></td>
                                <td style="  border: 1px solid #ddd;
    padding: 8px;
    text-align: left;"><a href="<?= site_url('admin/buku/delete_kategori/' . $pp['id_kategori']); ?>">hapus</a>
                                    <a href="<?= site_url('admin/buku/edit_kategori/' . $pp['id_kategori']); ?>">edit</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
