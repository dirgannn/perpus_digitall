    ...
    <div class="columns" id="app-content">
        ...
        <div class="column is-10" id="page-content">
            ...
            <div class="content-body">
                <button><a href="<?= site_url('admin/buku/tambah_buku'); ?>">tambah buku</a></button>
                <table style="border-collapse:collapse; width: 100%;">
                    <thead>
                        <tr>
                            <th style="border: 1px solid #ddd; padding: 8px; text-align: left;">#</th>
                            <th style="border: 1px solid #ddd; padding: 8px; text-align: left;">JUDUL BUKU</th>
                            <th style="border: 1px solid #ddd; padding: 8px; text-align: left;">PENULIS</th>
                            <th style="border: 1px solid #ddd; padding: 8px; text-align: left;">PENERBIT</th>
                            <th style="border: 1px solid #ddd; padding: 8px; text-align: left;">TAHUN TERBIT</th>
                            <th style="border: 1px solid #ddd; padding: 8px; text-align: left;">COVER</th>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($buku as $pp) { ?>
                            <tr>
                                ...
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><?= $pp['judul'] ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><?= $pp['penulis'] ?>
                                </td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;"><?= $pp['penerbit'] ?>
                                </td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;">
                                    <?= $pp['tahun_terbit'] ?></td>
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;">
                                    <?php if (!empty($pp['cover'])) : ?>
                                        <img src="<?= base_url('assets/uploads/covers/' . $pp['cover']) ?>" alt="Cover"
                                ...
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;">
                                    <?php if (!empty($pp['file'])) : ?>
                                        <a href="<?= site_url('admin/buku/view_pdf/' . $pp['file']) ?>" target="_blank">View
                                            PDF</a>
                                    <?php else : ?>
                                        No file
                                    <?php endif; ?>
                                ...
                                <td style="border: 1px solid #ddd; padding: 8px; text-align: left;">
                                    <a href="<?= site_url('admin/buku/delete_data/' . $pp['id_buku']); ?>"
                                        class="btn btn-danger">Delete</a>
                                    <a href="<?= site_url('admin/buku/edit_buku/' . $pp['id_buku']); ?>"
